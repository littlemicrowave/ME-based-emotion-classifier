...
\begin{figure}[H]
  \begin{center}
    \includegraphics*[height=0.5\textwidth]{Figures/Picture2.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics*[height=0.5\textwidth]{Figures/Picture3.png}
  \end{center}
  \caption{3D CNN}
  \label{fig:fig3}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics*[height=0.5\textwidth]{Figures/Picture4.png}
  \end{center}
