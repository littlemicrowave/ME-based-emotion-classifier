...
\author{%
  ...
  % Affiliation \\
  %University of Oulu, Finland \\
  \texttt{ sghaemin25@student.oulu.fi} \\
  \And
  Zhou Yang \\
  % Affiliation \\
  %University of Oulu, Finland \\
...
\begin{figure}[H]
  \begin{center}
    \includegraphics*[height=0.8\textwidth]{Figures/Picture3.png}
  \end{center}
  \caption{3D CNN}
  \label{fig:fig3}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics*[height=0.7\textwidth]{Figures/Picture4.png}
  \end{center}
